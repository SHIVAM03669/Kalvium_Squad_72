  ...
  return `
    <nav class="fixed w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-50 py-4 border-b border-gray-200 dark:border-gray-700">
      <div class="container mx-auto px-4 flex justify-between items-center">
        <a href="/" class="text-2xl font-bold text-[#FF3939] dark:text-[#FF5959]">SQUAD 72</a>
        <div class="flex items-center gap-6">
          ${[
            ...
            <a href="${path}" 
               class="text-gray-600 dark:text-white nav-link relative hover:text-[#FF3939] dark:hover:text-[#FF5959] transition-colors ${
